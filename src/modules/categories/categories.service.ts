...
export class CategoriesService {
  ...
  async update(id: number, dto: UpdateCategoryDto) {
    ...
    // Build the update data, excluding dto fields that map to relations
    const { department_id, defaultPerson_id, categoryGroup_id, ...rest } = dto;
    ...
    if (defaultPerson_id !== undefined) {
      updateData.defaultPerson_id = defaultPerson_id;
    }
    if (categoryGroup_id !== undefined) {
      updateData.categoryGroup_id = categoryGroup_id;
    }
